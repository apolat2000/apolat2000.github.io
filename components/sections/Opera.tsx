...
const Opera: React.FC<Props> = ({ title, description }) => {
  return (
    <Box paddingX={[4, 8, 32, 48]} paddingTop={12}>
      ...
      <SimpleGrid columns={[1, 2, 2, 3]} gap={4}>
        ...
        <ProjectCard
          ...
          description="A 3-D scene where you can create objects, move, rotate or delete them. Click Learn More to see the instructions."
